  ...
  <section class="card" id="box-profile">
    ...
    <div class="information">
      <div class="data">
        ...
        <p id="pAva" class="text-gray"><?php echo $ava;?></p>
      </div>
      ...
      <div class="data">
        ...
        <p id="pLocation" class="text-gray"><?php echo $l;?></p>
      </div>

      <div class="data">
        <p class="field"><b>Year Experience</b></p>
        <p id="pExp" class="text-gray"><?php echo $exp;?></p>
      </div>
    ...
    <section class="card" id="input-form">
      <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
        ...
        <div class="form-group">
          ...
          <input id="inputAva" type="text" name="ava">
        </div>
        ...
        <div class="form-group">
          <input id="submitBtn" onclick="" type="submit" name="submit" class="btn bg-green">
        </div>
      </form>
    </section>
